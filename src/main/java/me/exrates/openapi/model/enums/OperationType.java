...
import me.exrates.openapi.exception.model.UnsupportedOperationTypeException;
import org.springframework.context.MessageSource;

import java.util.*;

public enum OperationType {
    INPUT(1, TransactionSourceType.REFILL){{
    ...
    OUTPUT(2, TransactionSourceType.WITHDRAW),
    SELL(3),
    BUY(4),
