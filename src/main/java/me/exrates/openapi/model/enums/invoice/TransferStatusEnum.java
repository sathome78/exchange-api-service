...
public enum TransferStatusEnum implements InvoiceStatus {
  CREATED_USER(1) {
    ...
    public void initSchema(Map<InvoiceActionTypeEnum, InvoiceStatus> schemaMap) {
      schemaMap.put(InvoiceActionTypeEnum.POSTPONE, POSTPONED_AS_VOUCHER);
      schemaMap.put(InvoiceActionTypeEnum.POST, POSTED);
    }
  },
  POSTED(2) {
    @Override
  ...
  POSTPONED_AS_VOUCHER(4) {
    ...
    public void initSchema(Map<InvoiceActionTypeEnum, InvoiceStatus> schemaMap) {
      ...
      schemaMap.put(InvoiceActionTypeEnum.REVOKE_ADMIN, REVOKED_ADMIN);
      schemaMap.put(InvoiceActionTypeEnum.PRESENT_VOUCHER, POSTED);
    }
  };
  ...
  public InvoiceActionTypeEnum getStartAction(Boolean isVoucher) {
    if (isVoucher) {
      return InvoiceActionTypeEnum.POSTPONE;
    } else {
      return InvoiceActionTypeEnum.POST;
    }
  }
