...
import me.exrates.openapi.exception.model.*;
...
public enum InvoiceActionTypeEnum {
  CONFIRM_USER {{
    getProperty().setActionTypeButton(InvoiceActionTypeButtonEnum.CONFIRM_USER_BUTTON);
  }},
  CONFIRM_ADMIN {{
    getProperty().setActionTypeButton(InvoiceActionTypeButtonEnum.CONFIRM_ADMIN_BUTTON);
    getProperty().setOperationPermissionOnlyList(Arrays.asList(ACCEPT_DECLINE));
  }},
  REVOKE {{
    getProperty().setActionTypeButton(InvoiceActionTypeButtonEnum.REVOKE_BUTTON);
  }},
  REVOKE_ADMIN {{
    getProperty().setActionTypeButton(InvoiceActionTypeButtonEnum.REVOKE_ADMIN_BUTTON);
    getProperty().setOperationPermissionOnlyList(Arrays.asList(ACCEPT_DECLINE));
  }},
  EXPIRE,
  BCH_EXAMINE,
  ACCEPT_MANUAL {{
    getProperty().setActionTypeButton(InvoiceActionTypeButtonEnum.ACCEPT_BUTTON);
    getProperty().setOperationPermissionOnlyList(Arrays.asList(ACCEPT_DECLINE));
  ...
  DECLINE {{
    getProperty().setActionTypeButton(InvoiceActionTypeButtonEnum.DECLINE_BUTTON);
    getProperty().setOperationPermissionOnlyList(Arrays.asList(ACCEPT_DECLINE));
  }},
  DECLINE_HOLDED {{
    getProperty().setActionTypeButton(InvoiceActionTypeButtonEnum.DECLINE_HOLDED_BUTTON);
  ...
  POST_HOLDED {{
    getProperty().setActionTypeButton(InvoiceActionTypeButtonEnum.POST_HOLDED_BUTTON);
    getProperty().setAvailableForHolderOnly(true);
    getProperty().setOperationPermissionOnlyList(Arrays.asList(ACCEPT_DECLINE));
    getProperty().setLeadsToSuccessFinalState(true);
  }},
  TAKE_TO_WORK {{
    getProperty().setActionTypeButton(InvoiceActionTypeButtonEnum.TAKE_TO_WORK_BUTTON);
    getProperty().setOperationPermissionOnlyList(Arrays.asList(ACCEPT_DECLINE));
  }},
  RETURN_FROM_WORK {{
    getProperty().setActionTypeButton(InvoiceActionTypeButtonEnum.RETURN_FROM_WORK_BUTTON);
    getProperty().setAvailableForHolderOnly(true);
    getProperty().setOperationPermissionOnlyList(Arrays.asList(ACCEPT_DECLINE));
  }},
  CREATE_BY_USER,
  ...
  PUT_FOR_PENDING,
  ACCEPT_HOLDED {{
    getProperty().setActionTypeButton(InvoiceActionTypeButtonEnum.ACCEPT_HOLDED_BUTTON);
    getProperty().setAvailableForHolderOnly(true);
    getProperty().setOperationPermissionOnlyList(Arrays.asList(ACCEPT_DECLINE));
    getProperty().setLeadsToSuccessFinalState(true);
  }},
  ...
  POST,
  PRESENT_VOUCHER {{
    getProperty().setActionTypeButton(InvoiceActionTypeButtonEnum.SHOW_CODE_BUTTON);
    getProperty().setLeadsToSuccessFinalState(true);
  }};
