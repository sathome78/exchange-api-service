...
import static me.exrates.openapi.model.util.BigDecimalProcessing.doAction;
...
*/
    ...
    * */
    ...
    public BigDecimal getComissionForBuyRate() {
        return BigDecimalProcessing.normalize(comissionForBuyRate);
    }
    ...
    public BigDecimal getComissionForSellRate() {
        return BigDecimalProcessing.normalize(comissionForSellRate);
    }
    ...
    public BigDecimal getCurrencyBaseBalance() {
        return BigDecimalProcessing.normalize(currencyBaseBalance);
    }
    ...
    public BigDecimal getCurrencyConvertBalance() {
        return BigDecimalProcessing.normalize(currencyConvertBalance);
    }
    ...
    public BigDecimal getExchangeRate() {
        return BigDecimalProcessing.normalize(exchangeRate);
    }
    ...
    public BigDecimal getSpentWalletBalance() {
        return BigDecimalProcessing.normalize(spentWalletBalance);
    }
    ...
    public void setSpentAmount(BigDecimal spentAmount) {
        this.spentAmount = BigDecimalProcessing.normalize(spentAmount);
    }

    public BigDecimal getAmount() {
        return BigDecimalProcessing.normalize(amount);
    }
    ...
    public BigDecimal getTotal() {
        return BigDecimalProcessing.normalize(total);
    }
    ...
    public BigDecimal getTotalWithComission() {
        return BigDecimalProcessing.normalize(totalWithComission);
    }
