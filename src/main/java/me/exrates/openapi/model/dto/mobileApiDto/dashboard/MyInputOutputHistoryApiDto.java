package me.exrates.openapi.model.dto.mobileApiDto.dashboard;
...
import me.exrates.openapi.model.dto.onlineTableDto.MyInputOutputHistoryDto;
...
public class MyInputOutputHistoryApiDto {
    ...
    private final Set<WithdrawStatusEnum> FINAL_STATUSES = Stream.of(WithdrawStatusEnum.POSTED_AUTO, WithdrawStatusEnum.POSTED_MANUAL).collect(Collectors.toSet());
