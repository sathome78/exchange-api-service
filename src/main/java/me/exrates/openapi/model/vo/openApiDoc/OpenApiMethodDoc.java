package me.exrates.openapi.model.vo.openApiDoc;
...
public enum OpenApiMethodDoc {
    TICKER( OpenApiMethodGroup.PUBLIC,
    ...
    ORDER_BOOK(OpenApiMethodGroup.PUBLIC,
    ...
    HISTORY(OpenApiMethodGroup.PUBLIC,
    ...
    CURRENCY_PAIRS(OpenApiMethodGroup.PUBLIC,
    ...
    BALANCES(OpenApiMethodGroup.USER_INFO, "apiDoc.userInfo.balances", GET,
            "/user/balances",
    ...
    USER_OPEN_ORDERS(OpenApiMethodGroup.USER_INFO, "apiDoc.userInfo.openOrders", GET,
            "/user/orders/open",
    ...
    USER_CLOSED_ORDERS(OpenApiMethodGroup.USER_INFO, "apiDoc.userInfo.closedOrders", GET,
            "/user/orders/closed",
    ...
    COMMISSIONS(OpenApiMethodGroup.USER_INFO, "apiDoc.userInfo.commissions", GET,
            "/user/commissions",
    ...
    OPEN_ORDERS(OpenApiMethodGroup.ORDERS, "apiDoc.orders.open", GET,
    ...
    CREATE_ORDER(OpenApiMethodGroup.ORDERS, "apiDoc.orders.create", POST,
            "/orders/create",
    ...
    CANCEL_ORDER(OpenApiMethodGroup.ORDERS, "apiDoc.orders.cancel", POST,
            "/orders/cancel",
    ...
    ACCEPT_ORDER(OpenApiMethodGroup.ORDERS, "apiDoc.orders.accept", POST,
            "/orders/accept",
