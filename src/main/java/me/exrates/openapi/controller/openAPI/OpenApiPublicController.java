...
import me.exrates.openapi.model.dto.mobileApiDto.CandleChartItemReducedDto;
...
import me.exrates.openapi.model.dto.openAPI.TradeHistoryDto;
...
import me.exrates.openapi.exception.service.CurrencyPairNotFoundException;
...
public class OpenApiPublicController {
    ...
    public List<TickerJsonDto> getDailyTicker(@RequestParam(value = "currency_pair", required = false) String currencyPair) {
        ...
        if (currencyPair != null) {
            currencyPairName = OpenApiUtils.transformCurrencyPair(currencyPair);
    ...
    public ResponseEntity<BaseResponse<List<TradeHistoryDto>>> getTradeHistory(@PathVariable(value = "currency_pair") String currencyPair,
        ...
        final String transformedCurrencyPair = OpenApiUtils.transformCurrencyPair(currencyPair);
    ...
    public ResponseEntity<BaseResponse<List<CandleChartItemReducedDto>>> getCandleChartData(@PathVariable(value = "currency_pair") String currencyPair,
        ...
        final CurrencyPair currencyPairByName = currencyService.getCurrencyPairByName(OpenApiUtils.transformCurrencyPair(currencyPair));
