...
import me.exrates.openapi.utils.ValidationUtil;
...
public class OpenApiUserInfoController {
    ...
    public List<UserOrdersDto> userClosedOrders(@RequestParam(value = "currency_pair", required = false) String currencyPair,
        ...
        final String currencyPairName = nonNull(currencyPair) ? OpenApiUtils.transformCurrencyPair(currencyPair) : null;

        ValidationUtil.validateNaturalInt(limit);
        ValidationUtil.validateNaturalInt(offset);
