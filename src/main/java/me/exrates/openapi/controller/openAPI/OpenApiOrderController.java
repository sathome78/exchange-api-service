package me.exrates.openapi.controller.openAPI;

import com.google.common.base.Strings;
import me.exrates.openapi.controller.model.BaseResponse;
...
import me.exrates.openapi.exception.service.api.ErrorCode;
import me.exrates.openapi.exception.service.api.InvalidCurrencyPairFormatException;
import me.exrates.openapi.exception.service.api.OpenApiError;
import me.exrates.openapi.exception.service.api.OrderParamsWrongException;
import me.exrates.openapi.service.userOperation.UserOperationService;
import me.exrates.openapi.service.util.OpenApiUtils;
import me.exrates.openapi.service.util.RestApiUtils;
...
public class OpenApiOrderController {
    ...
    public ResponseEntity<OrderCreationResultOpenApiDto> createOrder(@RequestBody @Valid OrderParamsDto orderParamsDto) {
        String currencyPairName = OpenApiUtils.transformCurrencyPair(orderParamsDto.getCurrencyPair());
    ...
    public ResponseEntity<BaseResponse<Map<String, Boolean>>> cancelOrder(@RequestBody Map<String, String> params) {
        final Integer orderId = Integer.parseInt(RestApiUtils.retrieveParamFormBody(params, "order_id", true));
    ...
    public Map<String, Boolean> acceptOrder(@RequestBody Map<String, String> params) {
        String orderIdString = RestApiUtils.retrieveParamFormBody(params, "order_id", true);
    ...
    public List<OpenOrderDto> openOrders(@PathVariable("order_type") OrderType orderType,
        ...
        String currencyPairName = OpenApiUtils.transformCurrencyPair(currencyPair);
